                                        ...
                                        <div class="d-flex align-items-start mb-xl-3 mb-2">
                                            <div class="ms-auto mr-sm-auto">
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        <button type="button" class="btn btn btn-primary btn-xs update" data-product-id="<?php echo $content_value->product_id; ?>" data-directory="<?php echo $content_value->directory; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('update'); ?></button>
