        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background:
                ...
                url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo $school['admin_login_page_background']; ?>') no-repeat center center / cover;
            padding: 24px;
        }
...
<body>
    <div class="login-card">
        ...
        <form action="<?php echo site_url('site/login') ?>" method="post">
            ...
            <div class="field">
                <label class="field-label" for="form-username"><?php echo $this->lang->line('username'); ?></label>
                <div class="input-wrap">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    <input type="text" name="username" id="form-username" placeholder="<?php echo $this->lang->line('username'); ?>" value="<?php echo set_value('username') ?>" autocomplete="username">
                </div>
                <span class="field-error"><?php echo form_error('username'); ?></span>
            </div>

            <div class="field">
                <label class="field-label" for="form-password"><?php echo $this->lang->line('password'); ?></label>
                <div class="input-wrap toggle">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                    <input type="password" name="password" id="form-password" placeholder="<?php echo $this->lang->line('password'); ?>" value="<?php echo set_value('password') ?>" autocomplete="current-password">
